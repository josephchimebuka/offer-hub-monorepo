...
import { ArrowUpRight, FileText, ShoppingCart, Sparkles } from "lucide-react";
        ...
        {NETWORK_LINKS.map(([from, to]) => {
          ...
          return (
            <line
              ...
              x2={target.x}
              y2={target.y}
              stroke="url(#ecommerce-network-line)"
              strokeWidth="0.35"
            ...
            <div className="relative z-10 grid items-end gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  <span>CASE STUDY: LVL-2 COMMERCE</span>
                </motion.div>
                ...
                >
                  Protecting Every Transaction, Buyer to Seller
                </motion.h1>

                <p className="mt-8 max-w-2xl text-lg font-medium leading-relaxed text-content-secondary md:text-xl">
                  A deep dive into escrow-secured e-commerce: automatic delivery
                  escrow, buyer-protection windows, dispute handling, and
                  instant seller payouts on Stellar — without custodial risk.
                </p>
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                  ...
                  <div className="inline-flex items-center gap-2 rounded-xl bg-bg-base px-4 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-content-secondary shadow-neu-sunken-subtle">
                    <ShoppingCart size={14} className="text-theme-primary" />
                    Trustless commerce infrastructure
                  </div>
                </div>
              </div>
