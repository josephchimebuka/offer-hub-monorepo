...
import { ArrowUpRight, FileText, Users2, Sparkles } from "lucide-react";
        ...
        {NETWORK_LINKS.map(([from, to]) => {
          ...
          return (
            <line
              ...
              x2={target.x}
              y2={target.y}
              stroke="url(#dao-payroll-network-line)"
              strokeWidth="0.35"
...
export default function DaoPayrollHero() {
            ...
            <div className="relative z-10 grid items-end gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  <span>CASE STUDY: LVL-3 GOVERNANCE</span>
                </motion.div>
                ...
                >
                  Trustless Payroll for Decentralized Organizations
                </motion.h1>

                <p className="mt-8 max-w-2xl text-lg font-medium leading-relaxed text-content-secondary md:text-xl">
                  The DAO payroll blueprint: on-chain budget allocation,
                  contributor milestone verification, and atomic USDC
                  distribution — with full governance auditability and zero
                  custodial risk.
                </p>
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                  ...
                  <div className="inline-flex items-center gap-2 rounded-xl bg-bg-base px-4 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-content-secondary shadow-neu-sunken-subtle">
                    <Users2 size={14} className="text-theme-primary" />
                    On-chain DAO payroll infrastructure
                  </div>
                </div>
              </div>
