  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-4">
        ...
        {isOfferHub && (
          <GrowthBadge label={metric.savingsLabel} value={metric.savingsValue} />
        )}
    ...
    <div className="inline-flex items-center bg-bg-sunken shadow-neu-sunken rounded-2xl p-1 gap-1">
      {(
        ...
        >
          {mode === key && (
            <motion.div
              layoutId="real-estate-toggle-bg"
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm font-bold text-content-primary">
          ...
          <span className="text-theme-primary">1,000,000× faster</span> than traditional escrow agents.
        </p>
      </div>
    ...
    <div className="relative w-full max-w-5xl mx-auto space-y-6 animate-fadeInScale">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {METRICS.map((metric, i) => (
          <MetricCardComponent key={metric.id} metric={metric} mode={mode} index={i} />
        ))}
      </div>
