...
import { ArrowUpRight, FileText, Home, Sparkles } from "lucide-react";
        ...
        {NETWORK_LINKS.map(([from, to]) => {
          ...
          return (
            <line
              ...
              x2={target.x}
              y2={target.y}
              stroke="url(#real-estate-network-line)"
              strokeWidth="0.35"
            ...
            <div className="relative z-10 grid items-end gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  <span>CASE STUDY: LVL-4 REAL WORLD</span>
                </motion.div>
                ...
                >
                  Securing Deposits, Removing Counterparty Risk
                </motion.h1>

                <p className="mt-8 max-w-2xl text-lg font-medium leading-relaxed text-content-secondary md:text-xl">
                  The real estate escrow blueprint: non-custodial deposit
                  locking, condition-based release against inspection reports,
                  and on-chain dispute settlement — for rental and purchase
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                  ...
                  <div className="inline-flex items-center gap-2 rounded-xl bg-bg-base px-4 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-content-secondary shadow-neu-sunken-subtle">
                    ...
                    Non-custodial real estate escrow
                  </div>
                </div>
              </div>
